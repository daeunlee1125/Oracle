...
INSERT INTO USER4 (NAME, AGE) 
VALUES ('정약용', 33); --GENDER에 NULL이 들어가서 에러!
...
INSERT INTO USER5 (NAME, GENDER)VALUES ('정약용', 'S'); -- GENDER CHECK조건 위배로 에러
INSERT INTO USER5 (NAME, GENDER, AGE)
VALUES ('정약용', 'M', 102); -- AGE CHECK 조건 위배로 에러
